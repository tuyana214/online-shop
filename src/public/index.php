...
$app->get('/admin', AdminController::class, 'getAdminPage');
$app->post('/add-new-product', AdminController::class, 'addNewProduct', \Request\AddNewProductRequest::class);
$app->post('/delete-product', AdminController::class, 'deleteProduct', \Request\DeleteProductRequest::class);
$app->get('/product-manage', AdminController::class, 'getProductManagerPage');
$app->run();